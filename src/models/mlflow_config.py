...
def setup_mlflow():
    ...
    try:
        ...
        if experiment is None:
            ...
            logger.info(f"Experiment esistente: {EXPERIMENT_NAME} (ID: {experiment_id})")
...
def register_model(model_name, model_version=None):
    ...
    try:
        ...
        logger.info(f"Modello registrato: {model_details.name} (v{model_details.version})")
...
def create_mlflow_run(model_name, model_params, metrics, artifacts_path=None, model=None):
    """
