...
def plot_results(all_results, results_dir):
    ...
    plt.tight_layout()
    plt.savefig(plots_dir / "baseline_models_comparison.png", dpi=300, bbox_inches='tight')
    logger.info(f"Grafico confronto salvato: {plots_dir / 'baseline_models_comparison.png'}")
